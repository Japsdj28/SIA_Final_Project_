...
CREATE TABLE `categories` (
  ...
  `cat_title` text CHARACTER SET ascii NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE `orders` (
  ...
  `qty` int(11) NOT NULL,
  `trx_id` varchar(255) CHARACTER SET ascii NOT NULL,
...
CREATE TABLE `products` (
  ...
  `product_keywords` varchar(25) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
INSERT INTO `products` (`product_id`, `product_name`, `product_price`, `product_quantity`, `product_image`, `product_keywords`) VALUES
(13, 'Headphone', 5000, 99, 'levitating-music-headphones-display.jpg', 'headp'),
(14, 'Laptop', 10000, 20, 'laptop.jpg', 'laptop');
...
INSERT INTO `users` (`id`, `fname`, `emailaddress`, `password`) VALUES
(1, 'Kim Jasper de Jesus', 'dejesusjasper09@gmail.com', '$2y$10$nx57guflbkMU8FKM9G.zju65yPpWqjtsjO2nIFFtsiGyxobwJnvy2'),
(2, 'Ashley Trugo', 'ashleytrugo123@gmail.com', '$2y$10$iVp2OKwvFO7BTfZPRGwxS.BTj7kJsmG.bqNEKeP5wyA7Us6trd7e2'),
(3, 'Kenneth Guevara', 'kennethguevara01@gmail.com', '$2y$10$uBvWVWoq/f4sbBMTwcfKm.J7Vg.wWx61aUtxQbH4hooHoyNsit5fy');
...
(5, 'Bruno', 'brunoadmin@gmail.com', '12345', '0'),
(8, 'Harry Den', 'harryden@gmail.com', '12345', '0'),
(9, 'Sample admin', 'sampleadmin123@gmail.com', '$2y$10$KynxS2s2XIFN2BMM3gXOg.hhKnc3QeZ4Kp3jWftYpLIhlWBcn5ivW', '0'),
(10, 'sampleadmin1', 'sampleadmin1@gmail.com', '$2y$10$tJ3fjHMpWG7hkeztO23E5OYpc2kxSu.2LxD5FoJEA6ttoKRoCAfLa', '0');
...
(7, 'sample', 'proj', 'sampleproj@gmail.com', '25f9e794323b453885f5181f1b624d0b', '0123424219', 'sample', 'sample');
...
(1, 'adminmary@gmail.com', 'admin1234');
...
INSERT INTO `book` (`id`, `bookpic`, `bookname`, `bookdetail`, `bookaudor`, `bookpub`) VALUES
(4, 'arrow.jpg', 'Scott Gallagher', '1st edition', 'no idea', 'Suscipit'),
(5, 'logo.png', 'Ferris Mclaughlin', 'Qui ex dolor fugiat ', 'Est voluptates offi', 'Dolorem earum accusa'),
(6, 'arrow.png', 'harry', 'Ea quas nulla ration', 'Ut dolorem culpa ex', 'Eum proident quidem'),
(7, 'Fantastic.png', '2022 Latest Book', 'new book with latest features ', 'Mr developer', 'null');
...
(1, 'studentmary', 'studentmary@gmail.com', '12345', 'student'),
...
(1, 'root', 'server', 'auth_db', '{\"quick_or_custom\":\"quick\",\"what\":\"sql\",\"db_select[]\":[\"auth_db\",\"library_management\",\"phpmyadmin\",\"sampledb_db\",\"test\",\"users\",\"virtualmed_db\"],\"aliases_new\":\"\",\"output_format\":\"sendit\",\"filename_template\":\"@SERVER@\",\"remember_template\":\"on\",\"charset\":\"utf-8\",\"compression\":\"none\",\"maxsize\":\"\",\"codegen_structure_or_data\":\"data\",\"codegen_format\":\"0\",\"csv_separator\":\",\",\"csv_enclosed\":\"\\\"\",\"csv_escaped\":\"\\\"\",\"csv_terminated\":\"AUTO\",\"csv_null\":\"NULL\",\"csv_structure_or_data\":\"data\",\"excel_null\":\"NULL\",\"excel_columns\":\"something\",\"excel_edition\":\"win\",\"excel_structure_or_data\":\"data\",\"json_structure_or_data\":\"data\",\"json_unicode\":\"something\",\"latex_caption\":\"something\",\"latex_structure_or_data\":\"structure_and_data\",\"latex_structure_caption\":\"Structure of table @TABLE@\",\"latex_structure_continued_caption\":\"Structure of table @TABLE@ (continued)\",\"latex_structure_label\":\"tab:@TABLE@-structure\",\"latex_relation\":\"something\",\"latex_comments\":\"something\",\"latex_mime\":\"something\",\"latex_columns\":\"something\",\"latex_data_caption\":\"Content of table @TABLE@\",\"latex_data_continued_caption\":\"Content of table @TABLE@ (continued)\",\"latex_data_label\":\"tab:@TABLE@-data\",\"latex_null\":\"\\\\textit{NULL}\",\"mediawiki_structure_or_data\":\"data\",\"mediawiki_caption\":\"something\",\"mediawiki_headers\":\"something\",\"htmlword_structure_or_data\":\"structure_and_data\",\"htmlword_null\":\"NULL\",\"ods_null\":\"NULL\",\"ods_structure_or_data\":\"data\",\"odt_structure_or_data\":\"structure_and_data\",\"odt_relation\":\"something\",\"odt_comments\":\"something\",\"odt_mime\":\"something\",\"odt_columns\":\"something\",\"odt_null\":\"NULL\",\"pdf_report_title\":\"\",\"pdf_structure_or_data\":\"data\",\"phparray_structure_or_data\":\"data\",\"sql_include_comments\":\"something\",\"sql_header_comment\":\"\",\"sql_use_transaction\":\"something\",\"sql_compatibility\":\"NONE\",\"sql_structure_or_data\":\"structure_and_data\",\"sql_create_table\":\"something\",\"sql_auto_increment\":\"something\",\"sql_create_view\":\"something\",\"sql_create_trigger\":\"something\",\"sql_backquotes\":\"something\",\"sql_type\":\"INSERT\",\"sql_insert_syntax\":\"both\",\"sql_max_query_size\":\"50000\",\"sql_hex_for_binary\":\"something\",\"sql_utc_time\":\"something\",\"texytext_structure_or_data\":\"structure_and_data\",\"texytext_null\":\"NULL\",\"yaml_structure_or_data\":\"data\",\"\":null,\"as_separate_files\":null,\"csv_removeCRLF\":null,\"csv_columns\":null,\"excel_removeCRLF\":null,\"json_pretty_print\":null,\"htmlword_columns\":null,\"ods_columns\":null,\"sql_dates\":null,\"sql_relation\":null,\"sql_mime\":null,\"sql_disable_fk\":null,\"sql_views_as_tables\":null,\"sql_metadata\":null,\"sql_drop_database\":null,\"sql_drop_table\":null,\"sql_if_not_exists\":null,\"sql_simple_view_export\":null,\"sql_view_current_user\":null,\"sql_or_replace_view\":null,\"sql_procedure_function\":null,\"sql_truncate\":null,\"sql_delayed\":null,\"sql_ignore\":null,\"texytext_columns\":null}'),
(3, 'root', 'server', 'proj_db', '{\"quick_or_custom\":\"quick\",\"what\":\"sql\",\"db_select[]\":[\"auth_db\",\"library_management\",\"phpmyadmin\",\"sampledb_db\",\"test\",\"users\",\"virtualmed_db\"],\"aliases_new\":\"\",\"output_format\":\"sendit\",\"filename_template\":\"@SERVER@\",\"remember_template\":\"on\",\"charset\":\"utf-8\",\"compression\":\"none\",\"maxsize\":\"\",\"codegen_structure_or_data\":\"data\",\"codegen_format\":\"0\",\"csv_separator\":\",\",\"csv_enclosed\":\"\\\"\",\"csv_escaped\":\"\\\"\",\"csv_terminated\":\"AUTO\",\"csv_null\":\"NULL\",\"csv_structure_or_data\":\"data\",\"excel_null\":\"NULL\",\"excel_columns\":\"something\",\"excel_edition\":\"win\",\"excel_structure_or_data\":\"data\",\"json_structure_or_data\":\"data\",\"json_unicode\":\"something\",\"latex_caption\":\"something\",\"latex_structure_or_data\":\"structure_and_data\",\"latex_structure_caption\":\"Structure of table @TABLE@\",\"latex_structure_continued_caption\":\"Structure of table @TABLE@ (continued)\",\"latex_structure_label\":\"tab:@TABLE@-structure\",\"latex_relation\":\"something\",\"latex_comments\":\"something\",\"latex_mime\":\"something\",\"latex_columns\":\"something\",\"latex_data_caption\":\"Content of table @TABLE@\",\"latex_data_continued_caption\":\"Content of table @TABLE@ (continued)\",\"latex_data_label\":\"tab:@TABLE@-data\",\"latex_null\":\"\\\\textit{NULL}\",\"mediawiki_structure_or_data\":\"data\",\"mediawiki_caption\":\"something\",\"mediawiki_headers\":\"something\",\"htmlword_structure_or_data\":\"structure_and_data\",\"htmlword_null\":\"NULL\",\"ods_null\":\"NULL\",\"ods_structure_or_data\":\"data\",\"odt_structure_or_data\":\"structure_and_data\",\"odt_relation\":\"something\",\"odt_comments\":\"something\",\"odt_mime\":\"something\",\"odt_columns\":\"something\",\"odt_null\":\"NULL\",\"pdf_report_title\":\"\",\"pdf_structure_or_data\":\"data\",\"phparray_structure_or_data\":\"data\",\"sql_include_comments\":\"something\",\"sql_header_comment\":\"\",\"sql_use_transaction\":\"something\",\"sql_compatibility\":\"NONE\",\"sql_structure_or_data\":\"structure_and_data\",\"sql_create_table\":\"something\",\"sql_auto_increment\":\"something\",\"sql_create_view\":\"something\",\"sql_create_trigger\":\"something\",\"sql_backquotes\":\"something\",\"sql_type\":\"INSERT\",\"sql_insert_syntax\":\"both\",\"sql_max_query_size\":\"50000\",\"sql_hex_for_binary\":\"something\",\"sql_utc_time\":\"something\",\"texytext_structure_or_data\":\"structure_and_data\",\"texytext_null\":\"NULL\",\"yaml_structure_or_data\":\"data\",\"\":null,\"as_separate_files\":null,\"csv_removeCRLF\":null,\"csv_columns\":null,\"excel_removeCRLF\":null,\"json_pretty_print\":null,\"htmlword_columns\":null,\"ods_columns\":null,\"sql_dates\":null,\"sql_relation\":null,\"sql_mime\":null,\"sql_disable_fk\":null,\"sql_views_as_tables\":null,\"sql_metadata\":null,\"sql_drop_database\":null,\"sql_drop_table\":null,\"sql_if_not_exists\":null,\"sql_simple_view_export\":null,\"sql_view_current_user\":null,\"sql_or_replace_view\":null,\"sql_procedure_function\":null,\"sql_truncate\":null,\"sql_delayed\":null,\"sql_ignore\":null,\"texytext_columns\":null}'),
(5, 'root', 'server', 'authproj_db', '{\"quick_or_custom\":\"quick\",\"what\":\"sql\",\"db_select[]\":[\"auth_db\",\"library_management\",\"phpmyadmin\",\"sampledb_db\",\"test\",\"users\",\"virtualmed_db\"],\"aliases_new\":\"\",\"output_format\":\"sendit\",\"filename_template\":\"@SERVER@\",\"remember_template\":\"on\",\"charset\":\"utf-8\",\"compression\":\"none\",\"maxsize\":\"\",\"codegen_structure_or_data\":\"data\",\"codegen_format\":\"0\",\"csv_separator\":\",\",\"csv_enclosed\":\"\\\"\",\"csv_escaped\":\"\\\"\",\"csv_terminated\":\"AUTO\",\"csv_null\":\"NULL\",\"csv_structure_or_data\":\"data\",\"excel_null\":\"NULL\",\"excel_columns\":\"something\",\"excel_edition\":\"win\",\"excel_structure_or_data\":\"data\",\"json_structure_or_data\":\"data\",\"json_unicode\":\"something\",\"latex_caption\":\"something\",\"latex_structure_or_data\":\"structure_and_data\",\"latex_structure_caption\":\"Structure of table @TABLE@\",\"latex_structure_continued_caption\":\"Structure of table @TABLE@ (continued)\",\"latex_structure_label\":\"tab:@TABLE@-structure\",\"latex_relation\":\"something\",\"latex_comments\":\"something\",\"latex_mime\":\"something\",\"latex_columns\":\"something\",\"latex_data_caption\":\"Content of table @TABLE@\",\"latex_data_continued_caption\":\"Content of table @TABLE@ (continued)\",\"latex_data_label\":\"tab:@TABLE@-data\",\"latex_null\":\"\\\\textit{NULL}\",\"mediawiki_structure_or_data\":\"data\",\"mediawiki_caption\":\"something\",\"mediawiki_headers\":\"something\",\"htmlword_structure_or_data\":\"structure_and_data\",\"htmlword_null\":\"NULL\",\"ods_null\":\"NULL\",\"ods_structure_or_data\":\"data\",\"odt_structure_or_data\":\"structure_and_data\",\"odt_relation\":\"something\",\"odt_comments\":\"something\",\"odt_mime\":\"something\",\"odt_columns\":\"something\",\"odt_null\":\"NULL\",\"pdf_report_title\":\"\",\"pdf_structure_or_data\":\"data\",\"phparray_structure_or_data\":\"data\",\"sql_include_comments\":\"something\",\"sql_header_comment\":\"\",\"sql_use_transaction\":\"something\",\"sql_compatibility\":\"NONE\",\"sql_structure_or_data\":\"structure_and_data\",\"sql_create_table\":\"something\",\"sql_auto_increment\":\"something\",\"sql_create_view\":\"something\",\"sql_create_trigger\":\"something\",\"sql_backquotes\":\"something\",\"sql_type\":\"INSERT\",\"sql_insert_syntax\":\"both\",\"sql_max_query_size\":\"50000\",\"sql_hex_for_binary\":\"something\",\"sql_utc_time\":\"something\",\"texytext_structure_or_data\":\"structure_and_data\",\"texytext_null\":\"NULL\",\"yaml_structure_or_data\":\"data\",\"\":null,\"as_separate_files\":null,\"csv_removeCRLF\":null,\"csv_columns\":null,\"excel_removeCRLF\":null,\"json_pretty_print\":null,\"htmlword_columns\":null,\"ods_columns\":null,\"sql_dates\":null,\"sql_relation\":null,\"sql_mime\":null,\"sql_disable_fk\":null,\"sql_views_as_tables\":null,\"sql_metadata\":null,\"sql_drop_database\":null,\"sql_drop_table\":null,\"sql_if_not_exists\":null,\"sql_simple_view_export\":null,\"sql_view_current_user\":null,\"sql_or_replace_view\":null,\"sql_procedure_function\":null,\"sql_truncate\":null,\"sql_delayed\":null,\"sql_ignore\":null,\"texytext_columns\":null}');
...
('root', '[{\"db\":\"auth_db\",\"table\":\"products\"},{\"db\":\"ecommerceapp\",\"table\":\"products\"},{\"db\":\"auth_db\",\"table\":\"users\"},{\"db\":\"ecommerceapp\",\"table\":\"admin\"},{\"db\":\"ecommerceapp\",\"table\":\"cart\"},{\"db\":\"ecommerceapp\",\"table\":\"user_info\"},{\"db\":\"ecommerceapp\",\"table\":\"brands\"},{\"db\":\"ecommerceapp\",\"table\":\"categories\"},{\"db\":\"ecommerceapp\",\"table\":\"orders\"},{\"db\":\"auth_db\",\"table\":\"orders\"}]');
...
('root', 'ecommerceapp', 'admin', '{\"CREATE_TIME\":\"2023-07-04 21:38:34\",\"col_order\":[0,1,2,3,4],\"col_visib\":[1,1,1,1,1]}', '2023-07-04 13:47:52');
...
('root', '2023-07-07 08:00:09', '{\"Console\\/Mode\":\"collapse\",\"Export\\/file_template_server\":\"auth_db\"}');
...
ALTER TABLE `pma__savedsearches`
  MODIFY `id` int(5) UNSIGNED NOT NULL AUTO_INCREMENT;
--
-- Database: `sampledb_db`
--
CREATE DATABASE IF NOT EXISTS `sampledb_db` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `sampledb_db`;
...
INSERT INTO `users` (`id`, `fname`, `username`, `emailaddress`, `password`) VALUES
(1, 'Juan Cruz', 'juanC', '', '$2y$10$boREQA6hNfEXGgH6BfV5bOFSYn.pFFCHV26l4ccw/yynuiSuCby/O'),
(2, 'Kim Jasper ', 'kjasper', 'dejesusjasper09@gmail.com', '$2y$10$xPmqsYmDDuHyVV9FdC8NDu/cLxMfxIOh26iYViKNAauZ9VCHIcc.6');
...
INSERT INTO `userstbl` (`UserID`, `UserName`, `Password`, `First Name`, `Last Name`) VALUES
(1, 'jasperdj', '12345', 'Kim Jasper ', 'De Jesus'),
(2, 'kjasper', '123456789', 'Kim Jasper ', 'De Jesus'),
(3, 'japs', '123456', 'Kim Jasper ', 'De Jesus'),
(4, 'jasperdj', '123456', 'Kim Jasper ', 'De Jesus'),
(5, 'jasperdj', '123456', 'Kim Jasper ', 'De Jesus');
...
--
-- Database: `virtualmed_db`
--
CREATE DATABASE IF NOT EXISTS `virtualmed_db` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `virtualmed_db`;
...
INSERT INTO `doctors_table` (`doctorid`, `doctortype`, `firstname`, `lastname`, `username`, `password`) VALUES
(1, 'Physician', 'Taylor', 'Swift', 'doctortaylor', 'doctoradmin'),
(2, 'Dermatologist', 'Miles', 'Morales', 'doctormiles', 'doctoradmin');
...
INSERT INTO `users_table` (`userid`, `username`, `password`, `firstname`, `lastname`) VALUES
(1, 'maryangeline', '12345', 'Mary Angeline', 'Dadia'),
(2, 'meripancake', '12345', 'Meri ', 'Dadia');
